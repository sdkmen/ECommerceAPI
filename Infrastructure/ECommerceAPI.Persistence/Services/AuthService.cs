...
namespace ECommerceAPI.Persistence.Services
{
    public class AuthService : IAuthService
    {
        ...
        {
            string accessTokenResponse = await _httpClient.GetStringAsync($"https://graph.facebook.com/oauth/acccess_token?client_id={_configuration["ExternalLoginSettings:Facebook:Client_ID"]}&client_secret={_configuration["ExternalLoginSettings:Facebook:Client_Secret"]}&grant_type=client_credentials");
        ...
        public async Task<bool> VerifyResetTokenAsync(string resetToken, string userId)
        {
            ...
            if (user != null)
            {
                ...
                return await _userManager
                         .VerifyUserTokenAsync(user, _userManager.Options.Tokens.PasswordResetTokenProvider, "ResetPassword", resetToken);
            }
